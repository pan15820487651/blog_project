...
class LoginForm(forms.Form):
    '''
        登录
    '''
    username = forms.CharField(widget=forms.TextInput(attrs={"placeholder":"Username","requred":"required",}),
                               max_length=50,error_messages={"required":"username不能为空",})
    password = forms.CharField(widget=forms.PasswordInput(attrs={"placehold":"Password","required":"required",}),
                               max_length=50,error_messages={"required":"Pasword不能为空",})
